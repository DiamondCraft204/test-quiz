# KuisAI - Platform Kuis Cerdas dengan AI

Website kuis full-stack yang menggunakan **Gemini AI** untuk membuat soal secara otomatis dari materi PDF/Word.

## Fitur
- 🤖 **AI Generate Soal** — Upload PDF/DOCX → Gemini membuat soal otomatis
...
6. Klik **"Generate Soal AI"** — tunggu 30-60 detik
...
│       └── aiService.js      # Gemini AI generate soal
└── frontend/
    └── src/
        ├── pages/
        │   ├── Landing.jsx
...
| POST | /api/admin/quizzes | Buat kuis baru + AI |
